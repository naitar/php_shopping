...
{   
       ...
       empty($_POST['password']) || strlen($_POST['password']) < 4) 
    {
        ...
        {
            $passwordError = "Password should be 4 chars at lest";
        }
    }
    else
    {
        ...
        {
            $Rstmt = $pdo -> prepare("INSERT INTO users (name, email, password, address, phone) VALUES (:name, :email, :password, :address, :phone)");
            $register = $Rstmt -> execute(
            ...
            <div class="row">               
                <div class="col-lg-12">
                    <div class="login_form_inner">
                        <h3>Register to use our shop site</h3>
                        <form class="row login_form" action="register.php" method="post" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                style="<?php echo empty($nameError) ? '' : 'border: red 2px solid;';  ?>">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="email" name="email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'"
                                style="<?php echo empty($emailError) ? '' : 'border: red 2px solid;';  ?>">
                            </div>
                            <div class="col-md-12 form-group">
                                ...
                                style="<?php echo empty($phoneError) ? '' : 'border: red 2px solid;';  ?>">
                            </div>
                            <div class="col-md-12 form-group">
                                ...
                                style="<?php echo empty($addressError) ? '' : 'border: red 2px solid;';  ?>">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="password" class="form-control" id="password" name="password" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'"
                                style="<?php echo empty($passwordError) ? '' : 'border: red 2px solid;';  ?>">
